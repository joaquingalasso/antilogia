...
const boaShared = {
    ...
    ornament: { type: 'ornament', variant: 'svg', value: '<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448.99 418.66"><path d="M280.78,361.79c-.96-23.07,17.88-35.68,30.94-51.47,26.6"/></svg>' } as OrnamentBlock,
