...
export const translations = {
    // General UI
    anthologyTitle: { es: '☙ Antilogía', en: '☙ Antilogy' },
    subtitle_1: { es: 'Relatos breves desde el borde de la realidad.', en: 'Short stories from the edge of reality.' },
    subtitle_2: { es: 'Donde lo cotidiano se vuelve extraño.', en: 'Where the mundane becomes bizarre.' },
    ...
    backToAnthology: { es: 'Volver a la antilogía', en: 'Back to the antilogy' },
    noResultsTitle: { es: 'No se encontraron entradas', en: 'No entries found' },
    noResultsMessage: { es: 'Tu búsqueda no arrojó resultados.', en: 'Your search didn\'t return any results.'},
    comments: { es: 'Comentarios', en: 'Comments' },
    giscusComments: { es: '(Sección de comentarios de Giscus se cargaría aquí)', en: '(Giscus comments section would load here)' },
    ...
    // Navbar
    navWho: { es: 'Quién soy', en: 'Who I am' },
    navWhat: { es: 'Qué hago', en: 'What I do' },
    navHow: { es: 'Cómo lo hago', en: 'How I do it' },

    // Toggles & Controls
    sortNewest: { es: 'Ordenar por más antiguos', en: 'Sort by oldest' },
    sortOldest: { es: 'Ordenar por más recientes', en: 'Sort by newest' },
    ...
    published: { es: 'Edición', en: 'Edition' },
    author: { es: 'Autor', en: 'Author' },
    tags: { es: 'Etiquetas •', en: 'Tags •' },
    relatedStoriesTitle: { es: 'También te puede interesar', en: 'You might also like' },
    ...
    authorBio: { es: 'Autor de esta antilogía.', en: 'Author of this antilogy.' },
    copyright: { es: 'Antilogía. Todos los derechos reservados.', en: 'Anthology. All rights reserved.' },

    // Data: Categories
    'Relato Corto': { es: 'Relato Corto', en: 'Short Story' },
    'Fábula': { es: 'Fábula', en: 'Fable' },

    // Data: Tags
    'Suspenso': { es: 'Suspenso', en: 'Suspense' },
    'Psicológico': { es: 'Psicológico', en: 'Psychological' },
