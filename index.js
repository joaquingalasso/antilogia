...
var LinkPreviewSkeleton = () => /* @__PURE__ */ jsxs7("div", { className: "link-preview-card skeleton", children: [
  /* @__PURE__ */ jsx10("div", { className: "link-preview-image-skeleton" }),
  /* @__PURE__ */ jsxs7("div", { className: "link-preview-content", children: [
    /* @__PURE__ */ jsx10("div", { className: "link-preview-text-skeleton title" }),
    /* @__PURE__ */ jsx10("div", { className: "link-preview-text-skeleton" }),
    /* @__PURE__ */ jsx10("div", { className: "link-preview-text-skeleton short" }),
    /* @__PURE__ */ jsx10("div", { className: "link-preview-url-skeleton" })
  ] })
] });
var LinkPreview = ({ url }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx10(LinkPreviewSkeleton, {});
  }
  if (!data || data.error) {
    return /* @__PURE__ */ jsx10("div", { className: "link-preview-card error", children: /* @__PURE__ */ jsxs7("div", { className: "link-preview-content", children: [
      /* @__PURE__ */ jsx10("p", { className: "link-preview-title", children: t("linkPreviewErrorTitle") }),
      /* @__PURE__ */ jsx10("p", { className: "link-preview-description", children: t("linkPreviewErrorDesc") }),
      /* @__PURE__ */ jsx10("a", { href: url, target: "_blank", rel: "noopener noreferrer", className: "link-preview-url", children: url })
    ] }) });
  }
  const domain = new URL(url).hostname;
  return /* @__PURE__ */ jsxs7("a", { href: url, target: "_blank", rel: "noopener noreferrer", className: "link-preview-card", children: [
    data.image && /* @__PURE__ */ jsx10("div", { className: "link-preview-image", children: /* @__PURE__ */ jsx10("img", { src: data.image, alt: data.title, loading: "lazy" }) }),
    /* @__PURE__ */ jsxs7("div", { className: "link-preview-content", children: [
      /* @__PURE__ */ jsx10("p", { className: "link-preview-title", children: data.title }),
      /* @__PURE__ */ jsx10("p", { className: "link-preview-description", children: data.description }),
      /* @__PURE__ */ jsx10("p", { className: "link-preview-url", children: domain })
    ] })
  ] });
};
...
var renderBlock = (block, index) => {
  switch (block.type) {
    ...
    case "ornament": {
      ...
      return React5.cloneElement(ornamentDiv, { key: index });
    }
    case "linkPreview":
...
var { useEffect: useEffect4, useRef: useRef2 } = React7;
var GISCUS_CONFIG = {
...
var customGiscusThemeCss = `
/* --- Giscus Custom Theme for Antilog\xEDa --- */
:root {
...
var StoryView = ({ story, onBack, isVisible, allStories, onSelectStory, onTagSelect, theme }) => {
  ...
  return /* @__PURE__ */ jsxs11("article", { className: `view story-view ${!isVisible ? "hidden" : ""}`, "aria-hidden": !isVisible, children: [
    ...
    /* @__PURE__ */ jsxs11("section", { className: "comments-section", children: [
      ...
      /* @__PURE__ */ jsx15(Giscus, { storyId: story.id, theme, lang: language })
    ] })
  ] });
};
...
var { useState: useState5, useEffect: useEffect5, useMemo: useMemo4 } = React9;
var App = () => {
  const [theme, setTheme] = useState5("light");
  const [selectedStory, setSelectedStory] = useState5(null);
  const [searchQuery, setSearchQuery] = useState5("");
  const [activeFilter, setActiveFilter] = useState5("All");
  const [galleryView, setGalleryView] = useState5("grid");
  const [sortOrder, setSortOrder] = useState5("newest");
  const [activeTag, setActiveTag] = useState5("");
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState5(false);
...
if (rootElement) {
  ...
  root.render(
    /* @__PURE__ */ jsx23(React10.StrictMode, { children: /* @__PURE__ */ jsx23(LanguageProvider, { children: /* @__PURE__ */ jsx23(App, {}) }) })
  );
}
