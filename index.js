  ...
  switch (variant) {
    ...
    case "svg":
      if (value?.endsWith(".svg")) {
        return /* @__PURE__ */ jsx2("span", { className: "ornament-svg-wrapper", style: { maskImage: `url(${value})`, WebkitMaskImage: `url(${value})` } });
      }
...
var LinkPreview = ({ url, title, description, image }) => {
  ...
  return /* @__PURE__ */ jsxs7("a", { href: url, target: "_blank", rel: "noopener noreferrer", className: "link-preview-card", children: [
    image && /* @__PURE__ */ jsx10("div", { className: "link-preview-image", children: /* @__PURE__ */ jsx10("img", { src: image, alt: title, loading: "lazy" }) }),
    /* @__PURE__ */ jsxs7("div", { className: "link-preview-content", children: [
      /* @__PURE__ */ jsx10("p", { className: "link-preview-title", children: title }),
      /* @__PURE__ */ jsx10("p", { className: "link-preview-description", children: description }),
...
var renderBlock = (block, index) => {
  switch (block.type) {
    ...
    case "ornament": {
      ...
      const renderOrnamentContent = () => {
        switch (variant) {
          ...
          case "svg":
            if (value?.endsWith(".svg")) {
              return /* @__PURE__ */ jsx11("span", { className: "ornament-svg", style: { maskImage: `url(${value})`, WebkitMaskImage: `url(${value})` } });
            }
    ...
    case "linkPreview":
      return /* @__PURE__ */ jsx11(LinkPreview, { ...block }, index);
    default:
      return null;
  }
};
